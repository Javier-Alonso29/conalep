	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header bg-dark">
				<h5 class="modal-title" id="exampleModalLabel">Registrar nuevo proceso personal</h5>
				...
				<form method="POST" action="{{ route('misCarpetas.store') }}">
					...
					<div class="form-group">
						...
						<select class="form-control" id="select-proceso" name="proceso">
                            <option value="-0000">Selecciona un proceso</option>
					...
					<div class="form-group">
						...
						<select class="form-control" id="select-subProceso" name="subproceso">
                            <option value="-0000">Selecciona un sub proceso</option>
                        </select>
