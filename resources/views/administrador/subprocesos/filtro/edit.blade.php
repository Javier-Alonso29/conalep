	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header bg-black">
				<h5 class="modal-title" id="exampleModalLabel">Editar subproceso</h5>
			...
			<div class="modal-body">
				<form method="POST" action="{{ route('subprocesos.update.byproceso',1) }}">
					@csrf
					<input  type="hidden" name="id" id="id_subproceso">
					
					<div class="form-group">
						<label for="inicio">Nombre del subproceso</label>
						<input required type="text" id="edit_subproceso" name="nombre" class="form-control {{ $errors->has('nombre') ? ' is-invalid' : '' }}" autocomplete="off" value="{{ old('nombre') }}" >
