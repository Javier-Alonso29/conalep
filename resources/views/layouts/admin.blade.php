...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ asset('imagenes/conalep-logo-sin-letras.png') }}" alt="conalep Logo" class="brand-image img-circle elevation-1"
           style="opacity: .9">
      <span class="brand-text font-weight-light">CONALEP</span>
    </a>
    ...
    <div class="container">
        ...
        <p>Developed by: </p>
            ...
            <a href="#" data-toggle="lightbox" data-title="sample 1 - white">
                <img src="{{ asset('imagenes/conalep-logo-sin-letras.png')  }}" class="img-fluid mb-2" alt="white sample"/>
            </a>
        </div>
